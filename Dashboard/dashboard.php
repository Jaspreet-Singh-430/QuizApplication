...
if (isset($_SESSION["user"]) || isset($_COOKIE['usermail'])) {
    ...
    <body>
        <div class="container-fluid">
            <ul class="nav bg-warning p-3 d-flex" id="uppernav">
                <li class="nav-item me-4"><i class="fa-solid fa-house-chimney me-2" style="color:white;"></i><a
                        href="dashboard.php" class="text-decoration-none"><b>Home</b></a></li>
                <li class="nav-item me-4"><i class="fa-solid fa-question me-2" style="color: #ffffff;"></i><a
                        href="high_score.php" class="text-decoration-none"><b>High Score</b></a></li>
                <li class="nav-item me-4"><b>|</b></li>
                <li class="nav-item me-4"><i class="fa-solid fa-calendar-days me-2" style="color: #ffffff;"></i><a
                        href="./Events/usersideEvents.php" class="text-decoration-none"><b>Events</b></a></li>
                <li class="nav-item me-4"><i class="fa-solid fa-ranking-star me-2" style="color: #ffffff;"></i><a
                        href="./Leaderboard/leaderboard.php" class=" text-decoration-none"><b>Leaderboard</b></a></li>
                <li class="nav-item me-4"><i class="fa-solid fa-person-chalkboard me-2" style="color: #ffffff;"></i></i><a
                        href="./Instructions/instruction.php" class="text-decoration-none"><b>Instructions</b></a></li>
                <li class="nav-item ms-auto me-4"><i class="fa-solid fa-gear me-2" style="color: #ffffff;"></i><a
                        href="Profile/profile.php" class="text-decoration-none"><b>Profile Settings</b></a></li>
                <li class="nav-item"><i class="fa-solid fa-arrow-right-from-bracket me-2" style="color: #ffffff;"></i><a
                        href="../Logout//userlogout.php" class="text-white text-decoration-none"
                        id="logout"><b>Logout</b></a></li>
            ...
            <ul class="nav bg-dark p-2 d-flex align-content-center">
                ...
                <li class="nav-item me-3 d-flex"></i><a href="../Transaction/myTransaction.php"
                        class="nav-link align-self-center"><i class="fa-solid fa-money-bill me-2"
                            style="color: #ffffff;"></i>MY TRANSACTIONS</a></li>
                <li class="nav-item me-3 d-flex"><a href="../Feedback/feedback.php" class="nav-link align-self-center"><i
                            class="fa-regular fa-comment me-2" style="color: #ffffff;"></i>FEEDBACK</a></li>
                <li class="nav-item me-3 d-flex" style="position:relative;"><a href="./Badges/badges.php"
                        class="nav-link align-self-center">BADGES<span
                            class="indicate"><?php echo @$_SESSION['badge']; ?></span></a></li>
            ...
            <div id="quizbox" class="">
                ...
                <div class="mt-2">
                    <p><br></p>
                    <a href="../Quiz/quizplay.php?cat=history">History</a>
                    <a href="../Quiz/quizplay.php?cat=society_and_culture">Society and Culture</a>
                    <a href="../Quiz/quizplay.php?cat=science">Science</a>
                    <a href="../Quiz/quizplay.php?cat=geography">Geography</a>
                </div>
                <div class="mt-2">
                    <p><br></p>
                    <a href="../Quiz/quizplay.php?cat=food_and_drink">Food and Drink</a>
                    <a href="../Quiz/quizplay.php?cat=general_knowledge">General Knowledge</a>
                    <a href="../Quiz/quizplay.php?cat=">Miscellaneous</a>
                </div>
            </div>
            <div class="text-bg-secondary text-center p-3"><b>Welcome dear <?php echo $_SESSION['user']; ?> to Quiz World.
                    Play many
            ...
            <div class="row px-5 justify-content-between">
                ...
                <div class="card text-white bg-danger col-md-3 px-0">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../Quiz/Results/myresults.php" class="stretched-link"></a>
                    </div>
                </div>
                <div class="card card-link bg-primary text-white col-md-3 px-0">
                    ...
                    <div class="card-body bg-success">
                        ...
                        <a href="./Badges/mybadges.php" class="stretched-link"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row  text-bg-dark my-0">
                ...
                <div class="col-6 text-end py-3 px-3">Follow us : &nbsp;&nbsp;<a style="color:white;"
                        href="https://www.facebook.com/jaspreet.singh2808"><i class="fa fa-facebook me-4"></i></a>
                    <a style="color:white;" href="https://www.instagram.com/jas_preet1234singh?igsh=YzljYTk1ODg3Zg=="><i
                            class="fa fa-instagram me-4"></i></a>
                    <a href="https://www.linkedin.com/in/jaspreetsingh2882000?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                        style="color:white;"><i class="fa fa-linkedin me-4"></i></a>
                </div>
            </div>
        </div>
        <script>
                ...
                if (count == 1) {
                    for (let x in items) {
                        ...
                        res[x].onclick = function () {
                            ...
                            autolist.innerHTML = ''
                            go.href = "../Quiz/quizplay.php?cat=" + res[x].textContent
                        }
                    }
                }
                for (let y in items) {
    ...
    echo "<a href='../Login/userLogin.php'>Click Here to log in yourself</a>";
} else {
    echo "<p>You are not an authenticated user.Hence You are not allowed to visit this page</p><br>";
    echo "<a href='../Registration/signup.php'>Click Here to register yourself</a>";
}
?>