    ...
    <div class="container-fluid p-5">
        <div class="row">
            <div class="col text-center">
                <h2 class="d-block mx-auto" style="color:purple;"><i class="fa-solid fa-star"></i> Score Related Badges
                </h2><br>
            </div>
        </div>
        <div class="row">
            ...
            while ($rec3 = mysqli_fetch_array($data3)) {
                ...
                <div class="col-md-3 mb-4">
                    <div class="card" style="height:400px;">
                        <img class="card-img-top" src=<?php echo "../../images/screenshots/" . $rec3[3]; ?> width="150px"
                            height="150px" alt="Title" />
                        <div class="card-body text-bg-secondary">
                            <h4 class="card-title"><?php echo $rec3[0]; ?></h4>
                            <p class="card-text"><?php echo $rec3[2]; ?></p>
                            <hr>
                            <b style="font-size:20px;">Status: </b><span
                                style="font-size:20px;"><?php echo $rec3[4]; ?>&nbsp;&nbsp;</span>
                            <?php
                            if ($rec3[4] == 'Pending') {
                                ?>
                                ...
                                ?>
                                <i style="font-size:20px;color:yellowgreen;"
                                    class="fa-solid fa-check bg-white p-1 rounded-circle"></i>
                                <?php
                            }
                            ?>
                        </div>
        ...
        <div class="row">
            <div class="col text-center">
                <h2 class="d-block mx-auto" style="color:purple;"><i class="fa-solid fa-bars-progress"></i> Challenge
                    Related Badges</h2><br>
            </div>
        </div>
        <div class="row">
            ...
            while ($rec4 = mysqli_fetch_array($data4)) {
                ...
                <div class="col-md-3 mb-4">
                    <div class="card" style="height:400px;">
                        <img class="card-img-top" src=<?php echo "../../images/screenshots/" . $rec4[3]; ?> width="150px"
                            height="150px" alt="Title" />
                        <div class="card-body text-bg-primary">
                            ...
                            <hr>
                            <b style="font-size:20px;">Status: </b><span
                                style="font-size:20px;"><?php echo $rec4[4]; ?>&nbsp;&nbsp;</span>
                            <?php
                            if ($rec4[4] == 'Pending') {
                                ?>
                                <i style="font-size:20px;" class="fa-solid fa-spinner"></i>
