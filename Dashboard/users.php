...
<body>
    ...
    <div class="container">
        <table class="table table-hover table-striped table-bordered my-2 border-dark">
            <caption>
                <p class="display-4">Registered Users</p>
            </caption>
            <tr>
            ...
            while ($row = mysqli_fetch_array($data)) {
                ...
                <tr>
                    <td class="p-0"><span><?php echo $row[0]; ?></span>
                        <input type="text" class="inv" name='fname' form='updation' value="<?php echo $row[0]; ?>">
                    </td>
                    <td class="p-0"><span><?php echo $row[1]; ?></span><input type="text" form='updation' name='lname'
                            class='inv' value="<?php echo $row[1]; ?>"></td>
                    <td class="p-0"><span><?php echo $row[2]; ?></span><input type="text" form='updation' name='eml'
                            class='inv' value="<?php echo $row[2]; ?>"></td>
                    <td class="p-0"><span><?php echo $row[3]; ?></span><input type="text" form='updation' name='pwd'
                            class='inv' value="<?php echo $row[3]; ?>"></td>
                    <td class="p-0"><span><?php echo $row[4]; ?></span><input type="text" form='updation' name='cont'
                            class='inv' value="<?php echo $row[4]; ?>"></td>
                    <td class="p-0"><span><?php echo $row[5]; ?></span><input type="text" form='updation' name='id'
                    ...
                    <td><button class="btn btn-secondary" type="submit" form="updation"
                            formaction="update.php">Update</button></td>
