...
<body>
    <nav class="p-3 fs-3 text-white" style="background:purple;"><i
            class="fa-solid fa-person-chalkboard"></i><b>&nbsp;&nbsp;Instruction Guide</b></nav>
    <div class="container" style="padding:3%;">
        ...
        <section class="instructions">
            ...
            <ul>
                ...
                <li>You have <strong>limited number of lives</strong> to complete the quiz in Survival Challenge Mode.
                </li>
                <li>Make sure to answer the questions correctly. Unanswered questions will be result in no credit. Wrong
                    answers deduct your score by 25% of the score value.</li>
