...
$b = @$_GET['b'];
if ($b != 'finished')
    $err = '*You can not delete these contests as there may be registered participants who may have made payments for registration as well as those events which have not finished yet.';
else {
                ...
                while ($row = mysqli_fetch_array($data)) {
                    ...
                    <tr>
                        ...
                        <td><a class='btn btn-success'
                                href="createEvents.php?a=<?php echo $row[0]; ?>&b=<?php echo $row[1]; ?>&c=<?php echo $row[2]; ?>&d=<?php echo $row[5]; ?>&e=<?php echo $row[7]; ?>&f=<?php echo $row[8]; ?>">Change</a>
                        </td>
                        <td><a class='btn btn-danger'
                                href="manageEvents.php?a=<?php echo $row[0]; ?>&b=<?php echo $row[6]; ?>"
                                id="del">Delete</a>
                        </td>
                    </tr>
                    <?php
