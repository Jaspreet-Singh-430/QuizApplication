...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" form="quiz" name="qname" id="" <?php if (isset($_GET['a']))
                echo "readonly"; ?> value="<?php echo @$_GET['b']; ?>" aria-describedby="helpId" placeholder="Quiz name" />
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" form="quiz" <?php if (isset($_GET['a']))
                echo "readonly"; ?>
                name="fees" id="" aria-describedby="helpId" value="<?php echo @$_GET['e']; ?>"
                placeholder="For e.g. 200" />
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Due Date</label>
            <input type="datetime-local" class="form-control" form="quiz" name="due" id="" aria-describedby="helpId"
                ...
                <tr>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <select name='options[]' form='quiz' class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                multiple>
                            </select>
                        </div>
                    </td>
                    <td>
                        <div class="dropdown">
                            ...
                            <select name='correct[]' form='quiz' class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                multiple>
                            </select>
                        </div>
                    </td>
