      ...
      <div class="card">
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
          <div class="card-body text-center">
            <img src="<?php echo $_SESSION['prof']; ?>" class="rounded-circle d-block mx-auto" width="100px"
              height="100px" alt="">
            <br>
            <p style="font-weight:bold;"><?php echo $_SESSION['em']; ?></p>
            ...
            <form action="editProfile.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="lname" name="lname" placeholder="Enter your lastname"
                  value="<?php echo $_SESSION['userL']; ?>" required>
              </div>
              <!-- Email -->
              <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" id="email" name="email" placeholder="Enter your email"
                  value="<?php echo $_SESSION['em']; ?>" required>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="password"
                  placeholder="Enter new password (optional)" value="<?php echo $_SESSION['pw']; ?>">
              </div>
