        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-1">
                        <a class="nav-link" href="../Login/adminLogin.php">Logout</a>
                    </li>
                </ul>
            </div>
        </nav>
                                ...
                                <div class="accordion-item nav-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                        ...
                                        <div class="accordion-body bg-light">
                                            <a class="nav-link" href="../Quiz/createQuizes.php"> Create Quizzes</a>
                            ...
                            <li class="accordion" id="accordionExample2">
                                <div class="accordion-item nav-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="accordion-body bg-light">
                                            <a class="nav-link" href="./Events/createEvents.php">Organize Events</a>
                                            <a class="nav-link" href="./Events/manageEvents.php"> Manage Events</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
