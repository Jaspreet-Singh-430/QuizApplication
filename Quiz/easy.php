                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($data)) {
                            ...
                            <tr class="">
                                ...
                                <td><a href="./instructions.php?cat=<?php echo @$_GET['cat'];?>&type=<?php echo $type[$i];?>&no_of_ques=<?php echo $row[1];?>&sec=<?php echo $row[$i+4];?>&name=<?php echo $row[0];?>&level=<?php echo $_GET['level'];?>"
