    ...
    <div class="container mt-5">
        ...
        <div class="card my-4">
            ...
            <form action="statistics.php" method="post" id="statistics">
                <input type="text" name="correct" value="<?php echo $correct; ?>" hidden>
                <input type="text" name="wrong" value="<?php echo $incorrect; ?>" hidden>
                <input type="text" name="unattended" value="<?php echo $unattended; ?>" hidden>
                <input type="text" name="score" value="<?php echo $score; ?>" hidden>
                <input type="text" name="total" value="<?php echo $total; ?>" hidden>
                <input type="text" name="ttaken" value="<?php echo $tt_per_q; ?>" hidden>
                <input type="text" name="accuracy" value="<?php echo $accuracy; ?>" hidden>
            </form>
            <div class="card-body">
        ...
        <!-- Action Buttons -->
        <div class="text-center">
            <a href="../Quiz/quizplay.php" class="btn btn-primary">Retake Quiz</a>
