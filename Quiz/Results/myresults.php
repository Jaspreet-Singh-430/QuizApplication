...
<body>
    ...
    <div class="container-fluid">
        <nav class="p-3 fs-3 text-white" style="background:purple;"><img src="../../images/result.jpeg" width=10%
                height=10% alt="" class="rounded-circle img-fluid">
            <img src="../../images/test.webp" width=10% height=10% alt=""
                class="rounded-circle img-fluid mx-2"><b>&nbsp;&nbsp;My Results</b>
        </nav>
        <br>
