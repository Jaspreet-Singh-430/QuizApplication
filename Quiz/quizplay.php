...
<body>
    <div class="container-fluid px-0">
        <h1 class=" mb-3 bg-primary text-white p-3 rounded-4 row lev"><span style="font-weight:bolder;float:left;"
                ...
                Level</span>
            <span class="col-8">
                <img src="../images/test2.png" alt="" style="float:right;" class="imga rounded-circle img-fluid">
                <img src="../images/test3.png" alt="" style="float:right;" class="rounded-circle me-4 img-fluid imga">
            </span>
        </h1>
        ...
        <div class='row justify-content-evenly'>
            ...
            <div class="col-3 ">
                <a href="easy.php?cat=<?php echo @$_GET['cat']; ?>&level=medium" data-toggle="tooltip"
                    data-placement="bottom" title="abc"><img src="../images/medium.png"
                        class="img-fluid level rounded-5" alt=""></a>
            </div>
            <div class="col-3 ">
