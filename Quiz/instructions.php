                ...
                <div class="row my-4">
                    ...
                    <div class="col-6">
                        ...
                        if ($_GET['type'] == 'Time Duration') {
                            ...
                            ?>
                                <i class="fa-solid fa-hourglass-start mx-3"
                                    style="color: #74C0FC;font-size:70px;float:left;"></i>
                            <?php
                        } else {
                            ?>
                        ...
                        ?>
                        <span
                            style="font-weight:bold;font-size:24px;"><?php echo substr($_GET['sec'], 0, 2); ?></span><br>
                ...
                <div class="row fs-4">
                    <div class="col">
                        <ul class="list-group list-unstyled">
                            ...
                            <li class="list-group-item"><i class="fa-solid fa-check"></i>
                                <?php
