...
require 'vendor/autoload.php';
    ...
    <div class="container my-5">
        ...
        <div class="row my-4">
            <div class="col-md-6">
                <h2>Get in Touch</h2>
                <p>If you have any questions, comments, or suggestions, feel free to reach out to us using the form
                    below. We're here to help and always open to feedback to improve our quiz app.</p>
            ...
            <div class="col-md-6">
                <form action="contact.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="message" name='mesage' rows="5"
                            placeholder="Type your message here..." required></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" name="sub">Send Message</button>
                </form>

                <div class="alert alert-success alert-dismissible mt-3" style="visibility:hidden;"><button type="button"
                        class="btn-close" data-bs-dismiss="alert"></button>Your message is sent.</div>
