...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="contact.php">Contact <i
    ...
    <div class="container my-5">
        ...
        <div class="row my-4">
            <div class="col-md-6">
                <h2>Our Mission</h2>
                <p>Our mission is to create an engaging and educational platform where users can test their knowledge on
                    a variety of subjects. We believe that learning should be fun and accessible to everyone, and our
                    quiz app is designed with that in mind.</p>
            </div>
            <div class="col-md-6">
        ...
        <div class="row my-4">
            <div class="col-md-6 order-md-2">
                <h2>Our Team</h2>
                <p>We are a group of passionate developers, designers, and educators who came together to build this
                    quiz platform. Our diverse backgrounds and expertise allow us to create a well-rounded and
        ...
        <div class="row my-4">
            <div class="col-md-6">
                <h2>Our Vision</h2>
                <p>We envision a world where knowledge is easily accessible, and everyone has the opportunity to learn
                    and grow. Our platform is just the beginning, and we are constantly working to improve and expand
                    our offerings.</p>
            </div>
            <div class="col-md-6">
