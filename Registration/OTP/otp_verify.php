...
<body>
  <div class="container">
    <div class="otp-container">
      ...
      <form action="otp_verify.php" method="post">
        ...
        <span><a href="./otp_generation.php" class="">Resend OTP</a></span>
      </form>
    </div>
    ...
    <div class="modal fade" id="modalId" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog"
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body"><img src="../../images/check.png" width=60% height=60%
              style="display:block;margin:auto;" alt=""><span class="d-block" style="text-align:center;"><br>You are
  ...
  if ($_SESSION['otp'] == $otp) {
    ...
    setcookie("usermail", $email, time() + 86400 * 500, "/");
    setcookie("fullname", $fname . " " . $lname, time() + 86400 * 500, "/");
    // session_destroy();
  } else {
    ;
  }
