...
<body>
  ...
  $order=$_POST['orderId'];
  $cname=$_POST['cname'];
  $ins1="insert into payers values('$fname','$email','$order','$cname')";
  ...
  <div class="container fluid">
    ...
    <div class="alert alert-info">
      <strong>Note: </strong> Please change <span class="label label-info">$mode</span> to "TEST" in request.php if
      using Test appId/secretKey credentials. Access test credentials <a
    ...
    <form id="redirectForm" method="post" action="request.php">
      <div class="form-group">
        ...
        <input class="form-control" name="appId" value="TEST102977256faf5c8d756c9373d3b752779201" />
      </div>
      <div class="form-group">
        <label>Order ID:</label><br>
        <input class="form-control" name="orderId" readonly value="<?php echo $_POST['orderId']; ?>" />
      </div>
      <div class="form-group">
        <label>Order Name:</label><br>
        <input class="form-control" name="orderName" readonly value="<?php echo $_POST['cname']; ?>" />
      </div>
      <div class="form-group">
        <label>Order Amount:</label><br>
        <input class="form-control" name="orderAmount" value="<?php echo $_POST['pay'];?>" readonly />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control" name="returnUrl" value="http://localhost/Project/checkout/response.php" />
      </div>
      <div class="form-group">
